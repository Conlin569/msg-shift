...
package com.frxs.msg.shift.api.exception.enums;
...
public enum ErrorCodeEnum {
   ...
   * 未知错误
   */
  UNKNOWN_EXCEPTION(ErrorCodeScenarioEnum.UNKNOWN, ErrorCodeDetailEnum.UNKNOWN_EXCEPTION, "未知异常"),
  CONFIGURATION_ERROR(ErrorCodeScenarioEnum.CONFIG, ErrorCodeDetailEnum.CONFIGURATION_ERROR, "配置错误"),
  //========================================================================//
  //                               业务错误                                                                     //
  //========================================================================//
  //STAGED_PAY_UNKNOWN_EXCEPTION(ErrorCodeScenarioEnum.CHOICE_ACTIVITY, ErrorCodeDetailEnum.ACTIVITY_CREATE_ERROR, "营销事务异常"),;
  ;
